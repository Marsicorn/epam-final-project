...
export default class Loader extends React.Component {
	componentDidMount() {
		Loader.node = document.getElementById('loaderIcon');
	}

	static showLoader() {
		Loader.node.style.visibility = "visible";
	}

	static hideLoader() {
		Loader.node.style.visibility = "hidden";
	}
			...
			<div id="loaderIcon">
				<svg x="0px" y="0px" width="40px" height="40px" viewBox="0 0 40 40">
					<path
						opacity="0.2"
						fill="black"
						d="M20.201,5.169c-8.254,0-14.946,6.692-14.946,14.946c0,
